...
!   This is the main application for Mesh generation
!   The Mesh code is not a meshing software. Actually, it allows to refine a mesh and
!   to calculate properties such as displacement, buoyancy center, hydrostatic stiffness.
!   It also makes estimate of masses and inertia matrix. The concept with this software is
!   to write by hand a coarse description of the body under consideration and to have Mesh make
!   the refined mesh for Nemoh calculations.
!
!   @author TCSASSEMBLER
!   @version 1.1
PROGRAM Mesh
    ...
    call ExMaillage(ID,DSCRPT,X,Y,Z,NP,facette,NF,NFMX)
