...
CONTAINS
    ...
    SUBROUTINE ExMaillage(ID,DSCRPT,X,Y,Z,NP,facette,NF,NFMX)
        ...
        ! Maillage AQUAPLUS
        ! Fichier Tecplot
        open(10,file=ID%ID(1:ID%lID)//DSCRPT%ID(1:DSCRPT%lID)//'.tec')
        ...
        close(10)
        ! Fichier de maillage
        open(10,file=ID%ID(1:ID%lID)//DSCRPT%ID(1:DSCRPT%lID)//'.dat')
        ...
        open(10,file=ID%ID(1:ID%lID)//DSCRPT%ID(1:DSCRPT%lID)//'_info.dat')
